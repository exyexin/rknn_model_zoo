...
DATASETS = os.path.join('datasets','Anti-UAV-jiafang')

GT_PATH = os.path.join(os.getcwd(), '..', DATASETS, 'ground_truth')
DR_PATH = os.path.join(os.getcwd(), '..', DATASETS, 'mAP_label')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join(os.getcwd(), '..', DATASETS, 'val')
